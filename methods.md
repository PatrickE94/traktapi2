...
|recommendations.movies.get | GET | /recommendations/movies |  | required | 
|recommendations.movies.hide | DELETE | /recommendations/movies/:id | id | required | 
|recommendations.shows.get | GET | /recommendations/shows |  | required | 
...
|sync.ratings.get | GET | /sync/ratings/:type/rating | type | required | 
